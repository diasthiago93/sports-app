    ...
    <S.Container>
      ...
      <article>
        ...
        <p>
          ...
          eleifend urna neque, in vulputate mi scelerisque accumsan. Aenean sit
          amet ultrices nisl. Duis et sapien neque. Vestibulum suscipit orci ex,
          quis laoreet leo ornare vel. In suscipit lacus eu ligula sagittis
          laoreet. Interdum et malesuada fames ac ante ipsum primis in faucibus.
          In imperdiet libero non odio viverra, a venenatis ipsum fermentum.
          Nulla efficitur magna leo, vel maximus nisi dictum ac.
        </p>
        <p>    
          Aliquam laoreet tellus nec ligula luctus feugiat. Pellentesque sed
          ante fermentum, egestas lectus eget, elementum nibh. Sed sed cursus
          tortor. Suspendisse lorem ipsum, mattis nec ante non, viverra suscipit
          lacus. Nullam odio erat, convallis quis sapien ultrices, finibus
          vulputate nunc. Aenean elementum auctor odio non hendrerit. Morbi ut
          turpis in tortor rhoncus fringilla id eu nisi.
        </p>
        <p>É fácil e rápido para fechar já!</p>
      </article>
    </S.Container>
  );
};
